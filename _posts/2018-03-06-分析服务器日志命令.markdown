---
layout: post
title:  "CentOS 分析服务器日志命令"
date:   2018-03-06 15:00:24 +0800
...
### 查看2018年01月01日12时这一个小时内有多少IP访问
```bash
awk '{print $4, $1}' log_file | grep 01/Jan/2018:12 | awk '{print $2}' | sort | uniq | wc -l
```
